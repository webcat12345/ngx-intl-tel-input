...
| maskAsYouType            | `boolean`                | `false`                           | Masks the input as you type with using AsYouTypeFormatter. NOTE: Does not work with maskPlaceholder == true   |
| noDigitsPlaceholder      | `boolean`                | `false`                           | Masks the placeholder with 'X' instead or an example number.                                                  |
